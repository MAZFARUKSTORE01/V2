# Script Auto Tuneling For MAZFARUKSTORE 
...
<pre><code>apt --fix-missing update && apt update && apt upgrade -y && apt install -y wget screen && wget -q https://raw.githubusercontent.com/MAZFARUKSTORE01/V2/main/run && chmod +x run && ./run && screen -S run ./run</code></pre>
